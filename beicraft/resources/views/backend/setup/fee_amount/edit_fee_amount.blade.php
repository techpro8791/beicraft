        ...
        <div class="container-full">
                        ...
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('fee.amount.view') }}">Fee Category Amount</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Edit Student Fee Amount</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <section class="content">
                ...
                <div class="box-body">
                    <div class="row">
                    <div class="col">
                        <form method="POST" action=" {{ route('fee.amount.update', $edit_data[0]->fee_category_id) }} ">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="add_item">
                                                            ...
                                                            <div class="controls">
                                                                <select name="class_id[]" required class="form-control">
                                                                    ...
                                                                    @foreach ($student_classes as $student_class)
                                                                        <option value="{{ $student_class->id }}" {{ ($edit->class_id == $student_class->id ? "selected" : "") }}>{{ $student_class->name }}</option>
                                                                    @endforeach
