                                        ...
                                        <tbody>
                                            @foreach ($all_data as $key => $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>
                                                            <a title="Edit Details" href="{{ route('employee.attendance.edit', $value->date) }}" class="btn btn-info"> <i class="fa fa-edit"></i> </a>
                                                            <a title="View Details" href="{{ route('employee.attendance.details', $value->date) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                                        </center>
