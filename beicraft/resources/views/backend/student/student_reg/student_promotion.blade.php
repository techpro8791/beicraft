        ...
        <div class="container-full">
            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    ...
                    <div class="mr-auto">
                        <h3 class="page-title">Promote Student</h3>
            ...
            <section class="content">
                ...
                <div class="box-body">
                    <div class="row">
                    <div class="col">
                        <form method="POST" action="{{ route('student.registration.promotion.update', $edit_data->student_id) }}" enctype="multipart/form-data">
                            @csrf
