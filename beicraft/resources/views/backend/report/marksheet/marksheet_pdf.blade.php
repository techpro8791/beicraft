                    ...
                    <div class="col-12">
                        <div class="box bb-3 border-warning">
                            ...
                            <div class="box-header">
                                <h4 class="box-title">Student <strong>Marksheet PDF View</strong></h4>
                            </div>
                            ...
                            <div class="box-body" style="border: solid 1px; padding: 10px">
                                ...
                                <div class="row">
                                    <div class="col-md-2 text-center" style="float: right">
                                        <img src="{{ url('upload/no_image.jpg') }}" style="width: 120px; height: 100px">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="8" cellspacing="2">
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%">{{ $all_marks['0']['id_number'] }}</td>
                                            </tr>
