                        ...
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add Employee Leave</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input required type="date" name="start_date" id="disable_previous" class="form-control" min="<?php echo date('Y-m-d'); ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input required type="date" name="end_date" id="disable_previous" class="form-control" min="<?php echo date('Y-m-d'); ?>"/>
                                            </div>
                                        </div>
                                    </div>
