        ...
        <div class="container-full">
            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    ...
                    <div class="mr-auto">
                        <h3 class="page-title">Edit Student Fee Category</h3>
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="mdi mdi-home-outline"></i></a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('fee.category.view') }}">Fee Category</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Edit Student Fee Catory</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <section class="content">
                ...
                <div class="box-body">
                    <div class="row">
                    <div class="col">
                        <form method="POST" action=" {{ route('fee.category.update', $edit_data->id) }} ">
                            @csrf
                            <div class="row">
                            <div class="col-12">
